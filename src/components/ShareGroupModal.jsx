...
export default function ShareGroupModal({ message, show, onClose }) {
            ...
            >
                ...
                >
                    ...
                    <div className="flex justify-between items-start mb-4">
                        <div>
                            <h3 className="text-subtitle text-text">Group Summary</h3>
                            <p className="text-xs text-text-muted font-medium mt-0.5">Share with the whole group! 🌸</p>
                        </div>
